 ...
 */
package com.solodroid.android.exoplayer2.audio;
...
import com.solodroid.android.exoplayer2.BaseRenderer;
import com.solodroid.android.exoplayer2.C;
import com.solodroid.android.exoplayer2.ExoPlaybackException;
import com.solodroid.android.exoplayer2.ExoPlayer;
import com.solodroid.android.exoplayer2.Format;
import com.solodroid.android.exoplayer2.PlaybackParameters;
import com.solodroid.android.exoplayer2.PlayerMessage;
import com.solodroid.android.exoplayer2.Renderer;
import com.solodroid.android.exoplayer2.RendererCapabilities;
import com.solodroid.android.exoplayer2.audio.AudioRendererEventListener.EventDispatcher;
import com.solodroid.android.exoplayer2.decoder.DecoderInputBuffer;
import com.solodroid.android.exoplayer2.drm.DrmInitData;
...
import com.solodroid.android.exoplayer2.mediacodec.MediaCodecInfo;
import com.solodroid.android.exoplayer2.mediacodec.MediaCodecRenderer;
import com.solodroid.android.exoplayer2.mediacodec.MediaCodecSelector;
import com.solodroid.android.exoplayer2.mediacodec.MediaCodecUtil;
import com.solodroid.android.exoplayer2.mediacodec.MediaFormatUtil;
import com.solodroid.android.exoplayer2.util.MediaClock;
...
public class MediaCodecAudioRenderer extends MediaCodecRenderer implements MediaClock {
  ...
  protected int supportsFormat(MediaCodecSelector mediaCodecSelector,
    ...
    if (supportsFormatDrm && allowPassthrough(mimeType)
      ...
      return RendererCapabilities.ADAPTIVE_NOT_SEAMLESS | tunnelingSupport | RendererCapabilities.FORMAT_HANDLED;
    }
    ...
    if (decoderInfo == null) {
      return requiresSecureDecryption && mediaCodecSelector.getDecoderInfo(mimeType, false) != null
          ? RendererCapabilities.FORMAT_UNSUPPORTED_DRM : RendererCapabilities.FORMAT_UNSUPPORTED_SUBTYPE;
    }
    ...
    int formatSupport = decoderCapable ? RendererCapabilities.FORMAT_HANDLED : RendererCapabilities.FORMAT_EXCEEDS_CAPABILITIES;
    return RendererCapabilities.ADAPTIVE_NOT_SEAMLESS | tunnelingSupport | formatSupport;
  }
